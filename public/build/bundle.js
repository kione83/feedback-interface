...
var app = (function () {
    ...
    /* src/components/Card.svelte generated by Svelte v3.50.0 */
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-edd4f7");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1sj9mo"));
    			add_location(button, file$6, 6, 0, 119);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1sj9mo"))) {
    ...
    /* src/components/RatingSelect.svelte generated by Svelte v3.50.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-75wijr");
    			add_location(input0, file$5, 12, 8, 302);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-75wijr");
    			add_location(label0, file$5, 20, 8, 493);
    			attr_dev(li0, "class", "svelte-75wijr");
    			add_location(li0, file$5, 11, 4, 289);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-75wijr");
    			add_location(input1, file$5, 23, 8, 548);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-75wijr");
    			add_location(label1, file$5, 31, 8, 739);
    			attr_dev(li1, "class", "svelte-75wijr");
    			add_location(li1, file$5, 22, 4, 535);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-75wijr");
    			add_location(input2, file$5, 34, 8, 794);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-75wijr");
    			add_location(label2, file$5, 42, 8, 985);
    			attr_dev(li2, "class", "svelte-75wijr");
    			add_location(li2, file$5, 33, 4, 781);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-75wijr");
    			add_location(input3, file$5, 45, 8, 1040);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-75wijr");
    			add_location(label3, file$5, 53, 8, 1231);
    			attr_dev(li3, "class", "svelte-75wijr");
    			add_location(li3, file$5, 44, 4, 1027);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-75wijr");
    			add_location(input4, file$5, 56, 8, 1286);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-75wijr");
    			add_location(label4, file$5, 64, 8, 1477);
    			attr_dev(li4, "class", "svelte-75wijr");
    			add_location(li4, file$5, 55, 4, 1273);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-75wijr");
    			add_location(input5, file$5, 67, 8, 1532);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-75wijr");
    			add_location(label5, file$5, 75, 8, 1723);
    			attr_dev(li5, "class", "svelte-75wijr");
    			add_location(li5, file$5, 66, 4, 1519);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-75wijr");
    			add_location(input6, file$5, 78, 8, 1778);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-75wijr");
    			add_location(label6, file$5, 86, 8, 1969);
    			attr_dev(li6, "class", "svelte-75wijr");
    			add_location(li6, file$5, 77, 4, 1765);
    			...
    			attr_dev(input7, "class", "svelte-75wijr");
    			add_location(input7, file$5, 89, 8, 2024);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-75wijr");
    			add_location(label7, file$5, 97, 8, 2215);
    			attr_dev(li7, "class", "svelte-75wijr");
    			add_location(li7, file$5, 88, 4, 2011);
    			...
    			attr_dev(input8, "class", "svelte-75wijr");
    			add_location(input8, file$5, 100, 8, 2270);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-75wijr");
    			add_location(label8, file$5, 108, 8, 2461);
    			attr_dev(li8, "class", "svelte-75wijr");
    			add_location(li8, file$5, 99, 4, 2257);
    			...
    			attr_dev(input9, "class", "svelte-75wijr");
    			add_location(input9, file$5, 111, 8, 2516);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-75wijr");
    			add_location(label9, file$5, 119, 8, 2710);
    			attr_dev(li9, "class", "svelte-75wijr");
    			add_location(li9, file$5, 110, 4, 2503);
    			attr_dev(ul, "class", "rating svelte-75wijr");
    			add_location(ul, file$5, 10, 0, 265);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/FeedbackForm.svelte generated by Svelte v3.50.0 */

    const { console: console_1 } = globals;
    const file$4 = "src/components/FeedbackForm.svelte";

    // (55:12) <Button disabled={btnDisabled} type="submit">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(55:12) <Button disabled={btnDisabled} type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 57, 12, 1598);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			h2.textContent = "How would you rate our services?";
    			t1 = space();
    			form = element("form");
    			...
    			add_location(h2, file$4, 43, 8, 1093);
    			attr_dev(header, "class", "svelte-136y08r");
    			add_location(header, file$4, 42, 4, 1076);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell me how I'm doing");
    			attr_dev(input, "class", "svelte-136y08r");
    			add_location(input, file$4, 48, 12, 1303);
    			attr_dev(div, "class", "input-group svelte-136y08r");
    			add_location(div, file$4, 47, 8, 1265);
    			add_location(form, file$4, 45, 4, 1153);
    		},
    		m: function mount(target, anchor) {
    ...
    /* src/components/FeedbackItem.svelte generated by Svelte v3.50.0 */
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div, "class", "num-display svelte-oa8eig");
    			add_location(div, file$3, 11, 4, 279);
    			attr_dev(button, "class", "close svelte-oa8eig");
    			add_location(button, file$3, 14, 4, 342);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 15, 4, 418);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    /* src/components/FeedbackList.svelte generated by Svelte v3.50.0 */
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 7, 4, 192);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ scale, fade, FeedbackItem, feedback });
    ...
    /* src/components/FeedbackStats.svelte generated by Svelte v3.50.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$1, 6, 4, 99);
    			add_location(h41, file$1, 7, 4, 128);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 37, 0, 981);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*ratings*/ 1) feedbacklist_changes.feedback = /*ratings*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const deleteFeedback = e => {
    		...
    		$$invalidate(0, ratings = ratings.filter(item => item.id != itemId));
    	};

    	const addFeedback = e => {
    		const newFeedback = e.detail;
    		$$invalidate(0, ratings = [newFeedback, ...ratings]);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*ratings*/ 1) {
    			$$invalidate(2, count = ratings.length);
    		}

    		if ($$self.$$.dirty & /*ratings*/ 1) {
    			$$invalidate(1, average = ratings.reduce((acc, { rating }) => acc + rating, 0) / ratings.length);
    		}
    	};

    	return [ratings, average, count, deleteFeedback, addFeedback];
    }
